  ...
  return (
    <div className="os-wrapper">
      ...
      <div className="os-rows">
        ...
        <div className="os-row"><span>Estimated Tax</span><span>$0.00</span></div>
      </div>
      ...
      <p className="os-accept-label">WE ACCEPT</p>
      <div className="os-payment-icons">
        <span className="os-pay-badge">VISA</span>
        <span className="os-pay-badge">MC</span>
        <span className="os-pay-badge">AMEX</span>
        <span className="os-pay-badge">PAYPAL</span>
      </div>
      ...
      <div className="os-returns">↩ Easy 30-day returns</div>
    </div>
  );
}
