...
const products = [
  {
    name: 'Quilted Heritage Jacket',
    price: '$64.00',
    category: 'Outwear',
    img: '/images/img1.webp',
    colors: ['#5C6E4A', '#C8A882', '#3A5068'],
  },
  {
    name: 'Essentials Ribbed Set',
    price: '$48.00',
    category: 'Essentials',
    img: '/images/img2.webp',
    colors: ['#C8B89A', '#E8DCC8', '#A8B8C8'],
  },
  {
    name: 'Everyday Denim Overalls',
    price: '$52.50',
    category: 'Playwear',
  ...
  {
    name: 'Soft Pointelle Cardigan',
    price: '$42.00',
    category: 'Knitwear',
    img: '/images/img1.webp',
    colors: ['#E8C8A8', '#7EB8D4'],
  },
];
      ...
      <div className="section-inner">
        ...
        <div className="ymll-grid">
          {products.map((product, i) => (
            <div key={i} className="ymll-card">

              {/* Square image — no button inside */}
              ...
              {/* Quick Add — dark pill, full width, outside image */}
              <button className="ymll-quick-add">
                <CartIcon /> Quick Add
              </button>
